...
download_urls = {
    ...
    "Forge_server_1.8.9": "xxx",
    "Forge_server_1.8.8": "xxx",
    "Forge_server_1.8": "xxx",
    "Forge_server_1.7.10": "xxx",
    "Forge_server_1.7.10_pre4": "xxx",
    "Forge_server_1.7.2": "xxx",
    "Forge_server_1.6.4": "xxx",
    "Forge_server_1.6.3": "xxx",
    "Forge_server_1.6.2": "xxx",
    "Forge_server_1.6.1": "xxx",
    "Forge_server_1.5.2": "xxx",
    "Forge_server_1.5.1": "xxx",
    "Forge_server_1.5": "xxx",
    "Forge_server_1.4.7": "xxx",
    "Forge_server_1.4.6": "xxx",
    "Forge_server_1.4.5": "xxx",
    "Forge_server_1.4.4": "xxx",
    "Forge_server_1.4.3": "xxx",
    "Forge_server_1.4.2": "xxx",
    "Forge_server_1.4.1": "xxx",
    "Forge_server_1.4.0": "xxx",
    "Forge_server_1.3.2": "xxx",
    "Forge_server_1.2.5": "xxx",
    "Forge_server_1.2.4": "xxx",
    "Forge_server_1.2.3": "xxx",
    "Forge_server_1.1": "xxx",
    # fabric部分
...
version_files_mapping = {
    ...
    "Forge_server": {
        ...
        "1.7.10_pre4": ["Forge_server_1.7.10_pre4", "java-lite-v3"],
        ...
        "1.5.1": ["Forge_server_1.5.1", "java-lite-v3"],
        "1.5": ["Forge_server_1.5", "java-lite-v3"],
        "1.4.7": ["Forge_server_1.4.7", "java-lite-v3"],
        "1.4.6": ["Forge_server_1.4.6", "java-lite-v3"],
        "1.4.5": ["Forge_server_1.4.5", "java-lite-v3"],
        "1.4.4": ["Forge_server_1.4.4", "java-lite-v3"],
        "1.4.3": ["Forge_server_1.4.3", "java-lite-v3"],
        "1.4.2": ["Forge_server_1.4.2", "java-lite-v3"],
        "1.4.1": ["Forge_server_1.4.1", "java-lite-v3"],
        "1.4.0": ["Forge_server_1.4.0", "java-lite-v3"],
        "1.3.2": ["Forge_server_1.3.2", "java-lite-v3"],
        "1.2.5": ["Forge_server_1.2.5", "java-lite-v3"],
        "1.2.4": ["Forge_server_1.2.4", "java-lite-v3"],
        "1.2.3": ["Forge_server_1.2.3", "java-lite-v3"],
        "1.1": ["Forge_server_1.1", "java-lite-v3"],
    },
    "Fabric_server": {
